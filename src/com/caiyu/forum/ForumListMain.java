...
public class ForumListMain extends HttpServlet {
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res) {
		...
		try {
			...
			String querySQL = 
					"select forum_main.id,title,user_name,time from forum_main,user where subject_id=" + subjectId
			...
			if (rs.first()) {
				...
				do {
					...
					jsonObject.put(Param.RES_TITLE, rs.getString(2));
					jsonObject.put(Param.RES_AUTHOR, rs.getString(3));
					jsonObject.put(Param.RES_TIME, rs.getLong(4));
